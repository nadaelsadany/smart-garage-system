...
#define SPI_NSS_Hard_Master_SS_Output_En     (0x1U<<2)          //CR2. Bit 2 SSOE: SS output enable 1: SS output is enabled in master mode and when the cell is enabled
													         //HardWare Master Ouput Disable (Input)
#define SPI_NSS_Hard_Master_SS_Output_Dis    ~(0x1U<<2)        //CR2. Bit 2 SSOE: SS Output Disable means it is input to sens if one master take acces on line
